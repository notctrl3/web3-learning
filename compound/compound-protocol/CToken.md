...
基类合约,管理借贷资金池。Ceth和Cerc20继承CToken分别管理eth和IEP-20 token, 使用CErc20Delegator代理逻辑合约方便升级
### 主要变量
...
#### exchangeRateStoredInternal()
获取ctoken和原生资产的兑换率,当合约未mint任何token为初始兑换率。其他情况为`(totalCash + totalBorrows - totalReserves) / totalSupply`,
totalCash，totalBorrows， totalReserves，totalSupply分别为目前合约中的原生资产，总共借出还未偿还的资产，保留应对突发情况的资产，目前已经mint
的token数
